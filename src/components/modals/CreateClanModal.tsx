              ...
              <div className="space-y-8 ">
                <div className="flex items-center justify-center gap-4">
                   ...
                   <div>
                      ...
                      <div className="text-xl font-black text-white">1,000 <span className="text-yellow-500 text-sm">Vàng</span></div>
                   </div>
                </div>
             ...
             <div className="max-w-md w-full text-center space-y-10">
                <div className="space-y-4">
                   ...
                   <div className="space-y-1">
                     ...
                     <p className="text-gray-400 text-sm font-bold px-4">Bạn đồng ý chi phí <span className="text-yellow-500">1,000 Vàng</span> để thành lập <span className="text-blue-400">{formData.name}</span> chứ?</p>
                   </div>
                </div>
