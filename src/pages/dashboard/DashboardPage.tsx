    ...
    <div className="min-h-screen bg-black text-white font-sans flex selection:bg-fuchsia-500 selection:text-white overflow-hidden">
      ...
      <aside className="w-64 hidden lg:flex flex-col border-r border-white/10 bg-neutral-950/50 backdrop-blur-xl h-screen fixed top-0 left-0 z-50">
        ...
        <nav className="flex-1 py-6 px-4 space-y-2">
          ...
          <NavItem icon={Wallet} label="Ví tài sản" active={activeTab === 'wallet'} onClick={() => setActiveTab('wallet')} />
      ...
      <main className="flex-1 lg:ml-64 relative">
        ...
        <header className="h-20 flex items-center justify-between px-8 border-b border-white/10 sticky top-0 bg-black/80 backdrop-blur-md z-40">
          ...
          <div className="flex items-center gap-6">
            ...
            {/* Wallet Display */}
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-neutral-900 to-neutral-800 rounded-lg border border-white/10">
              <div className="w-6 h-6 rounded-full bg-yellow-500/20 flex items-center justify-center">
                 <span className="text-yellow-500 text-xs font-bold">$</span>
              </div>
              <span className="font-bold text-sm">$12,450.00</span>
              <button className="ml-2 w-6 h-6 bg-fuchsia-600 rounded flex items-center justify-center hover:bg-fuchsia-500 text-white transition-colors">
                <Plus size={14} />
              </button>
            </div>
        ...
        <div className="p-8 h-[calc(100vh-80px)] overflow-y-auto custom-scrollbar pb-20">
          ...
          {/* Main Layout: 2 Columns (Content + Sidebar Right) */}
