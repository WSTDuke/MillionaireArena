          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
              <h2 className="text-3xl font-bold text-white">
                {hasClan ? "Saigon Phantoms" : "Chưa tham gia Clan"}
              </h2>
              <span className="bg-gray-500/10 text-gray-500 border border-gray-500/20 px-2 py-0.5 rounded text-xs font-bold">
                {hasClan ? "LVL 12" : "LVL --"}
              </span>
            </div>
            <p className="text-gray-400 max-w-xl mb-6">
              {hasClan 
                ? "Nơi hội tụ những chiến binh bất khuất, cùng nhau chinh phục mọi giải đấu chuyên nghiệp."
                : "Hãy tìm hoặc tạo một Clan để bắt đầu hành trình cùng đồng đội của bạn!"}
            </p>
            
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-6">
               <StatBadge icon={Users} label="Thành viên" value={hasClan ? "24/50" : "0/0"} />
               <StatBadge icon={Trophy} label="Rank" value={hasClan ? "Master" : "--"} color="text-yellow-400" />
               <StatBadge icon={Target} label="Win Rate" value={hasClan ? "68%" : "0%"} color="text-green-400" />
            </div>
          ...
          <div className="lg:col-span-2 bg-neutral-900/50 border border-white/5 rounded-2xl p-6">
             <div className="flex justify-between items-center mb-6">
              ...
              <div className="space-y-4">
                <div className="text-center py-10 text-gray-500 italic text-sm">Chưa có thành viên...</div>
              </div>
          </div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-neutral-900/50 border border-white/5 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    <div className="col-span-full text-center py-20 text-gray-500 italic">Đang cập nhật danh sách Clan...</div>
                </div>
            </div>
        </div>
    )
